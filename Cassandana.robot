...
Cassandana metrics are initialized with the correct values
    Verify Cassandana Metric mqttServerInitialized_total equals 1
    Verify Cassandana Metric mqttHandleMessageConnect_total equals 0
    Verify Cassandana Metric mqttHandleMessage_total equals 0

Cassandana metric for mqttConnectionAttempts_total is increased on MQTT connect
    Connect to MQTT server    192.168.1.110
    Verify Casandana Metric mqttHandleMessageConnect_total equals 2
